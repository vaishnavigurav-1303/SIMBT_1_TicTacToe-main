...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void drawUI(Graphics page) {
        ...
        // DRAW score X
        ImageIcon xIcon = new ImageIcon("cros.png");
        Image xImg = xIcon.getImage();
        Image newXImg = xImg.getScaledInstance(25, 25, java.awt.Image.SCALE_SMOOTH);
        ImageIcon newXIcon = new ImageIcon(newXImg);
        page.drawImage(newXIcon.getImage(), 47 + offset * 1 + 190, 50 + offset * 0, null);
